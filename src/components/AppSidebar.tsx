  ...
  return (
    <Sidebar className="border-r border-sidebar-border">
      <div className="p-4 border-b border-sidebar-border">
        <a href="/"><img src={igniteupLogo} alt="IgniteUp" className="h-16 w-auto object-contain cursor-pointer" /></a>
      ...
      <SidebarContent>
        {(isAdminRole ? adminSections : isSponsorRole ? sponsorSections : isManagerRole ? managerSections : sections).map(section => {
